      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          <View style={styles.toggleContainer}>
            <Text style={{padding:10}}>Public</Text>
            <Switch value={isPublic} onValueChange={() => setPublic(!isPublic)} />
          </View>
          <View style={styles.toggleContainer}>
          ...
          <View style={styles.toggleContainer}>
            <Text style={{padding:10}}>Closed Relatives</Text>
            <Switch
              value={isClosedRelativesToggle}
              onValueChange={() => setClosedRelativesToggle(!isClosedRelativesToggle)}
            />
          </View>
